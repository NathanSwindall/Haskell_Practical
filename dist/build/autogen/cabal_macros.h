...
/* package cabal-chapter2-0.1.0.0 */
#ifndef VERSION_cabal_chapter2
#define VERSION_cabal_chapter2 "0.1.0.0"
#endif /* VERSION_cabal_chapter2 */
#ifndef MIN_VERSION_cabal_chapter2
#define MIN_VERSION_cabal_chapter2(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cabal_chapter2 */
...
#define CURRENT_PACKAGE_KEY "cabal-chapter2-0.1.0.0-AIsGbEEKLPt5pMMsADQOdZ"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "cabal-chapter2-0.1.0.0-AIsGbEEKLPt5pMMsADQOdZ"
